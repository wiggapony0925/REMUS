          ...
          setState(prev => ({
            ...
            messages: [...prev.messages, {
              ...
              content: [
                ...
                chalk.hex('#333333')('  ┌' + '─'.repeat(44) + '┐'),
                chalk.hex('#333333')('  │') + chalk.hex('#FF8C42').bold(' Chat') + ' '.repeat(40) + chalk.hex('#333333')('│'),
                chalk.hex('#333333')('  │') + `  ${chalk.hex('#FF8C42')('/clear')}         ${chalk.hex('#777777')('Clear conversation')}` + ' '.repeat(5) + chalk.hex('#333333')('│'),
                chalk.hex('#333333')('  │') + `  ${chalk.hex('#FF8C42')('/model')} ${chalk.hex('#555555')('<name>')}  ${chalk.hex('#777777')('Switch model')}` + ' '.repeat(10) + chalk.hex('#333333')('│'),
                chalk.hex('#333333')('  │') + `  ${chalk.hex('#FF8C42')('/compact')}       ${chalk.hex('#777777')('Compress context')}` + ' '.repeat(7) + chalk.hex('#333333')('│'),
                chalk.hex('#333333')('  ├' + '─'.repeat(44) + '┤'),
                chalk.hex('#333333')('  │') + chalk.hex('#FFA559').bold(' Intelligence') + ' '.repeat(32) + chalk.hex('#333333')('│'),
                chalk.hex('#333333')('  │') + `  ${chalk.hex('#FFA559')('/think')} ${chalk.hex('#555555')('<task>')}  ${chalk.hex('#777777')('Plan before executing')}` + ' '.repeat(2) + chalk.hex('#333333')('│'),
                chalk.hex('#333333')('  │') + `  ${chalk.hex('#FFA559')('/autofix')}       ${chalk.hex('#777777')('Auto-detect & fix errors')}` + ' '.repeat(0) + chalk.hex('#333333')('│'),
                chalk.hex('#333333')('  │') + `  ${chalk.hex('#FFA559')('/memory')}        ${chalk.hex('#777777')('View persistent memories')}` + ' '.repeat(0) + chalk.hex('#333333')('│'),
                chalk.hex('#333333')('  │') + `  ${chalk.hex('#FFA559')('/remember')} ${chalk.hex('#555555')('<x>')} ${chalk.hex('#777777')('Teach Remus a fact')}` + ' '.repeat(4) + chalk.hex('#333333')('│'),
                chalk.hex('#333333')('  ├' + '─'.repeat(44) + '┤'),
                chalk.hex('#333333')('  │') + chalk.hex('#FBBF24').bold(' Tasks') + ' '.repeat(38) + chalk.hex('#333333')('│'),
                chalk.hex('#333333')('  │') + `  ${chalk.hex('#FBBF24')('/task add')} ${chalk.hex('#555555')('<t>')}  ${chalk.hex('#777777')('Queue a task')}` + ' '.repeat(10) + chalk.hex('#333333')('│'),
                chalk.hex('#333333')('  │') + `  ${chalk.hex('#FBBF24')('/task list')}     ${chalk.hex('#777777')('Show task queue')}` + ' '.repeat(8) + chalk.hex('#333333')('│'),
                chalk.hex('#333333')('  │') + `  ${chalk.hex('#FBBF24')('/task run')}      ${chalk.hex('#777777')('Execute all queued tasks')}` + ' '.repeat(0) + chalk.hex('#333333')('│'),
                chalk.hex('#333333')('  ├' + '─'.repeat(44) + '┤'),
                chalk.hex('#333333')('  │') + chalk.hex('#67E8F9').bold(' History') + ' '.repeat(36) + chalk.hex('#333333')('│'),
                chalk.hex('#333333')('  │') + `  ${chalk.hex('#67E8F9')('/undo')}          ${chalk.hex('#777777')('Undo last file change')}` + ' '.repeat(2) + chalk.hex('#333333')('│'),
                chalk.hex('#333333')('  │') + `  ${chalk.hex('#67E8F9')('/redo')}          ${chalk.hex('#777777')('Redo last undone change')}` + ' '.repeat(0) + chalk.hex('#333333')('│'),
                chalk.hex('#333333')('  │') + `  ${chalk.hex('#67E8F9')('/sessions')}      ${chalk.hex('#777777')('List saved sessions')}` + ' '.repeat(5) + chalk.hex('#333333')('│'),
                chalk.hex('#333333')('  │') + `  ${chalk.hex('#67E8F9')('/save')}          ${chalk.hex('#777777')('Save current session')}` + ' '.repeat(3) + chalk.hex('#333333')('│'),
                chalk.hex('#333333')('  ├' + '─'.repeat(44) + '┤'),
                chalk.hex('#333333')('  │') + chalk.hex('#4ADE80').bold(' Metrics') + ' '.repeat(36) + chalk.hex('#333333')('│'),
                chalk.hex('#333333')('  │') + `  ${chalk.hex('#4ADE80')('/cost')}          ${chalk.hex('#777777')('Detailed cost breakdown')}` + ' '.repeat(0) + chalk.hex('#333333')('│'),
                chalk.hex('#333333')('  │') + `  ${chalk.hex('#4ADE80')('/speed')}         ${chalk.hex('#777777')('Performance metrics')}` + ' '.repeat(4) + chalk.hex('#333333')('│'),
                chalk.hex('#333333')('  │') + `  ${chalk.hex('#4ADE80')('/cache')}         ${chalk.hex('#777777')('Cache hit statistics')}` + ' '.repeat(3) + chalk.hex('#333333')('│'),
                chalk.hex('#333333')('  ├' + '─'.repeat(44) + '┤'),
                chalk.hex('#333333')('  │') + chalk.hex('#C084FC').bold(' Advanced') + ' '.repeat(35) + chalk.hex('#333333')('│'),
                chalk.hex('#333333')('  │') + `  ${chalk.hex('#C084FC')('/consensus')} ${chalk.hex('#555555')('<q>')} ${chalk.hex('#777777')('Multi-model consensus')}` + ' '.repeat(1) + chalk.hex('#333333')('│'),
                chalk.hex('#333333')('  │') + `  ${chalk.hex('#C084FC')('/agent')} ${chalk.hex('#555555')('<goal>')}  ${chalk.hex('#777777')('Autonomous agent mode')}` + ' '.repeat(2) + chalk.hex('#333333')('│'),
                chalk.hex('#333333')('  │') + `  ${chalk.hex('#C084FC')('/test')} ${chalk.hex('#555555')('<file>')}   ${chalk.hex('#777777')('Generate test suite')}` + ' '.repeat(4) + chalk.hex('#333333')('│'),
                chalk.hex('#333333')('  │') + `  ${chalk.hex('#C084FC')('/git')} ${chalk.hex('#555555')('<english>')} ${chalk.hex('#777777')('Git via natural language')}` + ' '.repeat(0) + chalk.hex('#333333')('│'),
                chalk.hex('#333333')('  │') + `  ${chalk.hex('#C084FC')('/watch')}         ${chalk.hex('#777777')('Live file watcher')}` + ' '.repeat(6) + chalk.hex('#333333')('│'),
                chalk.hex('#333333')('  │') + `  ${chalk.hex('#C084FC')('/diff')}          ${chalk.hex('#777777')('Toggle diff preview')}` + ' '.repeat(4) + chalk.hex('#333333')('│'),
                chalk.hex('#333333')('  └' + '─'.repeat(44) + '┘'),
                '',
                chalk.hex('#555555')('  ⌨ ') + chalk.hex('#777777')('Ctrl+C') + chalk.hex('#555555')(' cancel · ') + chalk.hex('#777777')('Enter') + chalk.hex('#555555')(' send'),
                '',
              ].join('\n'),
              timestamp: Date.now(),
            }],
